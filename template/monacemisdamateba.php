                        	...
                        	<?php
                        		...
                        		<div class="form-group">
		                        	...
		                        	<div class="input-group">
										...
										<input type="hidden" name="hidden<?=$datetime_count?>" id="hidden<?=$datetime_count?>" value="" />
										<input type="text" class="form-control form-input pull-right reservationtime" data-hiddenname="hidden<?=$datetime_count?>" data-name="<?=$form["name"]?>" data-attach="<?=$form["attach_column"]?>" data-important="<?=$form["important"]?>" data-type="dateandtimerange" value="" />
									</div>
								</div>
                        		<?php
                        		$datetime_count++;
