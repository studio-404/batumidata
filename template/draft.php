                ...
                <table class="table table-hover table-striped">
                  ...
                  ?>
                    <tr>
                      ...
                      <!-- <td class="mailbox-name"><a href="<?=WEBSITE.LANG?>/mailbox/readmail?id=<?=$value['id']?>&amp;back=mailbox/draft"><?=$value["fromusername"]?></a></td> -->
                      ...
                      <td>
                          <a href="<?=WEBSITE.LANG?>/mailbox/readmail?id=<?=$value['id']?>&amp;back=mailbox/draft"><i class="glyphicon glyphicon-eye-open"></i></a>
                          <a href="javascript:void(0)" style="padding:0 0 0 5px" class="remove-message" data-dlang="<?=LANG?>" data-catid="<?=$value["id"]?>"><i class="glyphicon glyphicon-remove"></i></a>
                      </td>
                    </tr>
                  <?php
                  }
